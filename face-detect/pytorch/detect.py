...
if __name__ == '__main__':
    ...
    for i in range(100):
        ...
        image_path = "/media/anarchicorganizer/Emilia/fakerecog/face-detect/pytorch/curve/test.jpeg"
        ...
        prior_data = priors.data.unsqueeze(0)
    ...
    print('net forward time: {:.4f}'.format((time.time() - tic)/100))
