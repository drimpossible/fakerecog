...
def parse_args():
    ...
    parser.add_argument('--out_dir', default='/media/anarchicorganizer/Emilia/fakerecog/data/dfdc_bursted_small/', type=str, help='Full path to where bursted datasets are stored')
