...
class ResNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 add_nonlocal=(False, False, False, False),
        ...
        self.layer1 = self._make_layer(block, 64, 256, shortcut_type, stride=1, num_blocks=layers[0],
                                       ...
                                       temp_strides=temp_strides_set[1], dcn=with_dcn, add_nonlocal=add_nonlocal[0])
        ...
        self.layer2 = self._make_layer(block, 256, 512, shortcut_type, stride=2, num_blocks=layers[1],
                                       ...
                                       dcn=with_dcn, add_nonlocal=add_nonlocal[1])
        ...
        self.layer3 = self._make_layer(block, 512, 1024, shortcut_type, stride=2, num_blocks=layers[2],
                                       ...
                                       dcn=with_dcn, add_nonlocal=add_nonlocal[2])
        ...
        self.layer4 = self._make_layer(block, 1024, 2048, shortcut_type, stride=1, num_blocks=layers[3],
                                       ...
                                       dcn=with_dcn, add_nonlocal=add_nonlocal[3])
    ...
    def _make_layer(self, block, dim_in, dim_out, shortcut_type, stride, num_blocks, dim_inner=None, group=None,
                    use_temp_convs=None, temp_strides=None, dcn=False, add_nonlocal=False):
        ...
        for idx in range(num_blocks):
            ...
            # if idx == num_blocks - 2 and add_nonlocal:
            #     layers.append(NONLocalBlock3D(in_channels=dim_in))
...
def resnet50(add_nonlocal, extract_features, **kwargs):
    """Constructs a ResNet-50 model.
    """
    use_temp_convs_set, temp_strides_set = obtain_arc(2)
    model = ResNet(Bottleneck, [3, 4, 6, 3], use_temp_convs_set, temp_strides_set, add_nonlocal=add_nonlocal,
...
def Net(num_classes=2, add_nonlocal=[False, False, False, False], extract_features=False, loss_type='softmax',
